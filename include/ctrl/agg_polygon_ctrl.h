...
namespace agg
{
    class AGG_EXTERN simple_polygon_vertex_source
    {
    public:
    ...
    class AGG_EXTERN polygon_ctrl_impl : public ctrl
    {
    public:
    ...
    //----------------------------------------------------------polygon_ctrl
    template<class ColorT> class AGG_EXTERN polygon_ctrl : public polygon_ctrl_impl
    {
    public:
