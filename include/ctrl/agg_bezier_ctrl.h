...
namespace agg
{
    ...
    //--------------------------------------------------------bezier_ctrl_impl
    class AGG_EXTERN bezier_ctrl_impl : public ctrl
    {
    public:
        bezier_ctrl_impl();
    ...
    //--------------------------------------------------------curve3_ctrl_impl
    class AGG_EXTERN curve3_ctrl_impl : public ctrl
    {
    public:
        curve3_ctrl_impl();
    ...
    //----------------------------------------------------------curve3_ctrl
    template<class ColorT> class AGG_EXTERN curve3_ctrl : public curve3_ctrl_impl
    {
    public:
        curve3_ctrl() :
            m_color(rgba(0.0, 0.0, 0.0))
